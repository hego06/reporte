...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <ul class="nav navbar-nav">
        <li>
            <a href="{{route('recibos.pdf')}}" class="btn imprimir btn btn-lg">
            <span class="glyphicon glyphicon-cog"></span>Generar recibos</a>
        </li>
        <li>
            <a href="{{route('download.recibos')}}" class="btn btn btn-lg">
            <span class="glyphicon glyphicon-save"></span>Descargar recibos</a>
        <li>
    </ul>
    <ul class="nav navbar-nav pull-right">
        <li>
            <a class="btn btn btn-lg" href="{{route('imprimir.recibos')}}">
